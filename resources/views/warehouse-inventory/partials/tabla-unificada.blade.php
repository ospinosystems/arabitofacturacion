                        ...
                        if (ubicacionesData.estado && ubicacionesData.ubicaciones) {
                            ...
                            if (ubicaciones.length > 0) {
                                let htmlUbicaciones = `
                                    <div class="mt-3 pt-3 border-t border-blue-300">
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="text-xs font-semibold text-blue-800">Ubicaciones del producto:</span>
                                            <span class="text-xs font-bold text-blue-900">Total: ${parseFloat(totalStock).toFixed(2)} unidades</span>
                                        </div>
                                ...
                                ubicaciones.forEach(ubicacion => {
                                    htmlUbicaciones += `
                                        <div class="flex items-center justify-between p-2 bg-blue-50 rounded border border-blue-200 text-xs">
                                            <div class="flex-1">
                                                <span class="font-mono font-bold text-blue-900">${ubicacion.codigo}</span>
                                                <span class="text-blue-700 ml-2">${ubicacion.nombre}</span>
                                            </div>
                                            <span class="font-bold text-blue-900 ml-2">${parseFloat(ubicacion.cantidad).toFixed(2)}</span>
                                        </div>
                                    `;
                                });
