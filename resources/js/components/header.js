                                    ...
                                    <div className="space-y-1">
                                        ...
                                        {openAdmin && (
                                            <div className="pl-2 ml-3 space-y-1 border-l border-gray-200">
                                                ...
                                                <button className={itemCls(view === "inventario" && subViewInventario === "inventario")} onClick={() => irInventario("inventario", "list")}><i className="w-4 mr-2 fa fa-boxes-stacked"></i>Inventario (solo lectura)</button>
