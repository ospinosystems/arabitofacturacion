...
class AuthenticateUser
{
    ...
    private const DICI_ALLOWED_ROUTES = [
        ...
        // WMS: slotting, ABC, datos físicos, conteo cíclico
        "wms/slotting/sugerir",
        "wms/slotting/decision",
        "wms/slotting/metricas",
        "wms/slotting/ocupacion",
        "wms/abc",
        "wms/abc/panel",
        "wms/medidas/pendientes",
        "wms/medidas",
        "wms/conteos",
        "wms/conteos/generar",
        "wms/conteos/registrar",
        "wms/conteos/{id}/tareas",
        "wms/conteos/{id}/ajustar",
        "wms/conteos/{id}/reporte",
        "wms/conteo",

        // TMS: flota, planificación, rutas y entregas
        "tms/vehiculos",
        "tms/conductores",
        "tms/planificar",
        "tms/rutas/crear",
        ...
        "tms/rutas",
        "tms/rutas/{id}",
        "tms/rutas/{id}/optimizar",
        "tms/rutas/{id}/estado",
        "tms/rutas/{id}/manifiesto",
        "tms/paradas/{id}/entrega",
        "tms/paradas/{id}/fallo",
        "tms/indicadores",
        "tms/panel",
