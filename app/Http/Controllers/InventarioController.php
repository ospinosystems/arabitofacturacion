    ...
    public function getEstadisticasFun($data)
    {
        ...
        return DB::table('inventarios')
            ...
            ->groupBy(
                ...
                'inventarios.id_proveedor',
                'inventarios.id_categoria',
                'inventarios.id_marca',
                'inventarios.unidad',
                'inventarios.id_deposito',
                'inventarios.descripcion',
                'inventarios.iva',
                'inventarios.porcentaje_ganancia',
                'inventarios.precio_base',
                'inventarios.precio',
                ...
                'inventarios.precio2',
                'inventarios.precio3',
                'inventarios.stockmin',
                'inventarios.stockmax',
                'inventarios.id_vinculacion',
                'inventarios.push',
                'inventarios.activo',
                'inventarios.created_at',
                'inventarios.updated_at'
            )
            ->selectRaw('
                inventarios.id,
                inventarios.super,
