...
Route::group(['middleware' => ['auth.user:login']], function () {
	...
	Route::group(['middleware' => ['auth.user:admin']], function () {
		...
		Route::post('fusionarPremontas', [sendCentral::class,"fusionarPremontas"]);
		...
		Route::post('transferencia-despacho/verificar-espejos', [TransferenciaDespachoController::class, 'verificarEspejos']);
...
// Proxy: estado del servidor central (MySQL/carga) para diagnóstico de saturación
Route::get('sync/central-server-stats', [SyncProgressController::class, 'centralServerStats'])->name('sync.central-server-stats');
